...
{
    public class WorkerAddedThenNotifyWorkerEventHandler : DomainEventHandlerBase<WorkerAdded>
    {
        ...
        public override async Task HandleAsync(WorkerAdded domainEvent)
        {
            NotificationInfo notificationInfo = new NotificationInfo()
            {
                NotificationType = NotificationType.WorkAdded,
